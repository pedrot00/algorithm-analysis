...
public:
    ...
    /*OK*/ int getWidth() const;
    /*OK*/ int getHeight() const;           //talvez possa ser excluidos se n forem usados
    /*OK*/ int get(int r, int c) const;                //retorna estado “pixel”  lin r, col c da tela
